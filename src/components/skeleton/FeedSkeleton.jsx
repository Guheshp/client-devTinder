...
const FeedSkeleton = () => {
    ...
    return (
        <>
            ...
            <div className='flex justify-center items-center mt-4 md:mt-14 px-4 md:px-0'>

                {/* Changed w-9/12 to w-full on mobile, keeping w-9/12 for desktop */}
                <div className='w-full md:w-9/12'>

                    {/* Changed to flex-col (stack) on mobile, flex-row (side-by-side) on md+ */}
                    <div className='flex flex-col md:flex-row my-6 md:my-14 gap-6'>

                        {/* ================= LEFT COLUMN ================= */}
                        {/* Hidden on Mobile (hidden), Visible on Tablet+ (md:flex) */}
                        <div className='hidden md:flex w-full md:w-[30%] flex-col gap-4'>

                            {/* Profile Card */}
                            <div className="card bg-base-100 shadow-xl border border-base-200 h-[400px] p-4 flex flex-col items-center overflow-hidden relative w-full">
                            ...
                            {/* Social Links Card - Hidden on tablet, visible on laptop if needed, or keep logic simple */}
                            <div className="card bg-base-100 shadow-xl border border-base-200 h-[220px] p-5 w-full hidden lg:block">
                        ...
                        {/* Width is 100% on mobile, 36% on desktop */}
                        <div className="w-full md:w-[36%] flex justify-center">
                            <div className="card bg-base-100 w-full shadow-xl border border-base-200 h-[600px] p-0 overflow-hidden flex flex-col">
                                ...
                                <div className='px-6 flex flex-col items-center -mt-12'>
                                    <ShimmerBlock className="w-32 h-32 md:w-36 md:h-36 rounded-full border-[6px] border-base-100" />
                        ...
                        {/* ================= RIGHT COLUMN ================= */}
                        {/* Hidden on Mobile/Tablet (hidden lg:flex), Visible on Laptop (lg:flex) */}
                        <div className='hidden lg:flex w-full md:w-[30%] flex-col gap-4'>

                            {/* Premium Banner */}
                            <div className="card bg-neutral/10 shadow-xl h-[180px] p-6 flex flex-col items-center justify-center relative overflow-hidden w-full">
                            ...
                            {/* Profile Strength */}
                            <div className="card bg-base-100 shadow-xl border border-base-200 p-5 w-full">
